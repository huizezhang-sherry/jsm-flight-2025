...
#
# flight_df_raw <- arrow::read_parquet("Year=2017/data_0.parquet") |>
...
all_routes <- read_csv('data/all_routes.csv')
nodes_df <- read_csv('data/nodes_df.csv')
routes_df <- read_csv('data/routes_df.csv')
airports <- read_csv('data/airports_in_cont_us.csv')
